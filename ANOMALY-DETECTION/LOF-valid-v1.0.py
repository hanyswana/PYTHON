#!/usr/bin/env python3
"""
Validate saved PyOD LOF (best joblib) on NEW dataset.

- Model:   /home/apc-3/PycharmProjects/PythonProjectAD/LOF/model/v1.0/lof_pyod_model_best.joblib
- Dataset: /home/apc-3/PycharmProjects/PythonProjectAD/dataset-glucose/raw/Lablink_330_validation.csv

Outputs:
- /home/apc-3/PycharmProjects/PythonProjectAD/LOF/validation-output/v1.0/validation_results.csv
- /home/apc-3/PycharmProjects/PythonProjectAD/LOF/validation-output/v1.0/validation_summary.txt
"""
...
MODEL_PATH = f"{DIR}/LOF/model/v1.0/lof_pyod_model_best.joblib"
DATA_PATH  = f"{DIR}/dataset-glucose/raw/Lablink_330_validation.csv"

OUT_DIR = f"{DIR}/LOF/validation-output/v1.0"

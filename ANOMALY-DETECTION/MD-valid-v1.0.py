#!/usr/bin/env python3
"""
Validate saved Mahalanobis Distance (MD) model (best joblib) on NEW dataset.

- Model:   /home/apc-3/PycharmProjects/PythonProjectAD/MD/model/v1.0/md_model_best.joblib
- Dataset: /home/apc-3/PycharmProjects/PythonProjectAD/dataset-glucose/raw/Lablink_330_validation.csv

Outputs:
- /home/apc-3/PycharmProjects/PythonProjectAD/MD/validation-output/v1.0/validation_results.csv
- /home/apc-3/PycharmProjects/PythonProjectAD/MD/validation-output/v1.0/validation_summary.txt
"""
...
MODEL_PATH = f"{DIR}/MD/model/v1.0/md_model_best.joblib"
DATA_PATH  = f"{DIR}/dataset-glucose/raw/Lablink_330_validation.csv"

OUT_DIR = f"{DIR}/MD/validation-output/v1.0"
...
def main():
    ...
    if mean is None or inv_cov is None or threshold is None:
        raise ValueError(
            "Joblib bundle missing required keys. Expected keys: mean, inv_cov, threshold, spectral_columns, config."
        )
    ...
    with open(OUT_SUMMARY_TXT, "w", encoding="utf-8") as f:
        f.write("Mahalanobis Distance Validation (MD^2)\n")
        f.write("-----------------------------------\n")

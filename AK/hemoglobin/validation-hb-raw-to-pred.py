...
# File paths
csv = 'reva-valid-raw-thumb'
data_file = f'/home/admin-3/PycharmProjects/PythonProjectAK-REVA/validation-1k-hb/dataset/{csv}.csv'
mod = '2024-12-20_16-28-37'
model = f'lablink_1k_hemoglobin_Norm_Manh_top_10.parquet_best_model_{mod}'
model_dir = f'/home/admin-3/PycharmProjects/PythonProjectAK-REVA/validation-1k-hb/model-1k-hb/{model}'
output_file_19 = f'/home/admin-3/PycharmProjects/PythonProjectAK-REVA/validation-1k-hb/result/RESULT_19_{csv}_manh_model_{mod}.csv'
output_file_10 = f'/home/admin-3/PycharmProjects/PythonProjectAK-REVA/validation-1k-hb/result/RESULT_10_{csv}_manh_model_{mod}.csv'

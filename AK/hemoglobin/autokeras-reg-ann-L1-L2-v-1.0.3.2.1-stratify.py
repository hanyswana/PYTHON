...
BASE_FOLDER = '/home/admin-3/PycharmProjects/PythonProjectAK-REVA/1k-lablink-L1L2-dropout/1k-hb/stratify-v2'
...
# File locations
DATASET_FOLDER = os.path.join(BASE_FOLDER, 'dataset/run/dataset-1k-hb-pls-top10-parquet-2.1')

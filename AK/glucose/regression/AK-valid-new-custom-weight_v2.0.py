...
csv = 'SALAM-data-2025-matched-csv'
dir = '/home/apc-3/PycharmProjects/PythonProjectAK/validation-1k-glucose'
data_file = f'{dir}/dataset/SALAM/{csv}.csv'
...
output_file = f'{dir}/result/result-SALAM/model-NEW-FLOW/{model_dir}'
...
all_spectral_data = df.loc[:, '415 nm':]
...
first_two_columns = df.iloc[:, :6]  # Keep the first two columns == SALAM ==
...
y_true = df.loc[:, "actual-glucose"].astype(float).values  # == SALAM ==
print(y_true)

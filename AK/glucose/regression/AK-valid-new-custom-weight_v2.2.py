"""
v2.2
Apply CT model v1.2 (10 raw input)
Model AK 10 input
"""
...
ct_model_path = f'{dir}/model-CT/CT_PDS_Lablink_model_v1.2.joblib'
...
output_file = f'{dir}/result/result-ALTY/model-NEW-FLOW/{model_dir}/v1.2-150'
...
# tf_model_dir = f'{dir}/model/model-NEW-FLOW/{model_dir}/{tf_model}'
# output_file = f'{dir}/result/result-ALTY/model-NEW-FLOW/{model_dir}/v1.1-150'
# tf_output_file_19 = f'{output_file}/RESULT_19_tf_{csv}_pp_model_{mod}.csv'
#
# # TFLite & TFLite model paths and output
...
spectral_data_CT = pds_model.transform(spectral_data)

# Preprocess the data
norm_euc_data = apply_norm_euc(pd.DataFrame(spectral_data_CT, columns=spectral_data_CT.columns, index=spectral_data_CT.index))

"""
v2.1
Apply CT model v1.1 (19 raw input)
...
ct_model_path = f'{dir}/model-CT/OC/model-v3/v1.1/raw-gs/CT_ORTH_Lablink_model.joblib'

# TensorFlow model paths and output == 4th model ==
mod = 'r2_0.33_87_'
...
output_file = f'{dir}/result/result-ALTY/model-NEW-FLOW/{model_dir}/OC/150/v1.1-150-gs'
...
# # TensorFlow model paths and output == v2 model ==
# mod = 'R2_0.91_93_'
# tf_model = f'Lablink_1k_glucose_RAW_SNV_batch16_{mod}'
# model_dir = "2nd_R2_0.91_93_"
# tf_model_dir = f'{dir}/model/model-v2/{model_dir}/{tf_model}'
# output_file = f'{dir}/result/result-ALTY/model-v2/{model_dir}/v1.1-150-snv'
# tf_output_file_19 = f'{output_file}/RESULT_19_tf_{csv}_pp_model_{mod}.csv'
#
# # TFLite & TFLite model paths and output
# tflite_model = f'{model_dir}.tflite'
# tflite_model_dir = f'{dir}/model/model-v2/{model_dir}/{tflite_model}'
...
spectral_data = all_spectral_data_ct[selected_wavelengths].copy()

# Preprocess the data
norm_euc_data = apply_norm_euc(pd.DataFrame(spectral_data, columns=spectral_data.columns, index=spectral_data.index))
# snv_array = snv(all_spectral_data)
# snv_data = pd.DataFrame(snv_array, columns=all_spectral_data.columns, index=all_spectral_data.index)
...
processed_data_ori = norm_euc_data

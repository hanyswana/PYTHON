...
ct_model_path = f'{dir}/model-CT/OC/model-v3/v1.3/normmanh_snv_1stderiv/CT_ORTH_Lablink_model_v1.3.joblib'
...
output_file = f'{dir}/result/result-ALTY/model-v3/{model_dir}/OC/v1.3-150'
...
all_spectral_data_ct = pds_model.transform(spectral_data)

processed_data = all_spectral_data_ct

"""
v2.3
Apply CT model v1.3 (10 preprocessed input)
Model AK 10 input
"""
...
ct_model_path = f'{dir}/model-CT/CT_PDS_Lablink_model_v1.3.joblib'
...
output_file = f'{dir}/result/result-ALTY/model-NEW-FLOW/{model_dir}/v1.3-150'
...
processed_data_ori = spectral_data

# === Apply PDS calibration transfer on full 19-band spectra BEFORE wavelength selection ===
pds_model = joblib.load(ct_model_path)
spectral_data_CT = pds_model.transform(processed_data_ori)
processed_data = spectral_data_CT

"""
v3.4
Apply CT model v1.4 (19 preprocessed input)
Model AK 19 input
"""
...
ct_model_path = f'{dir}/model-CT/OC/model-v3/v1.4/normmanh_snv_1stderiv/CT_ORTH_Lablink_model_v1.4.joblib'
...
output_file = f'{dir}/result/result-ALTY/model-v3/{model_dir}/OC/v1.4-150'
...
# Preprocess the data
norm_manh_data = apply_norm_manh(pd.DataFrame(all_spectral_data, columns=all_spectral_data.columns, index=all_spectral_data.index))
...
snv_data = pd.DataFrame(snv_array, columns=norm_manh_data.columns, index=norm_manh_data.index)
